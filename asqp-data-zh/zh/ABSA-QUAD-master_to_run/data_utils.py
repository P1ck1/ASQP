...
sentword2opinion = {'positive': '好', 'negative': '糟', 'neutral': '一般'}
    ...
    with open(data_path, 'r', encoding='UTF-8') as fp:
        ...
        for line in fp:
            ...
            if line != '':
                ...
                sents.append(list(jieba.cut(words)))  # 使用jieba分词
...
def get_para_asqp_targets(sents, labels):
    ...
    for label in labels:
        ...
        for quad in label:
            ...
            one_quad_sentence = f"{ac} 是 {man_ot} 因为 {at} 是 {ot}"
